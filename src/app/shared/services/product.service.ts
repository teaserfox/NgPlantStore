...
export class ProductService {
  ...
  getProducts(params: ActiveParamsType): Observable<{total: number, pages:number, items:ProductType[]}> {
    return this.http.get<{total: number, pages:number, items:ProductType[]}>(environment.api + 'products', {
      params:params
    });
  }
